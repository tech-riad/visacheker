...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 mt-2 font-weight-bold text-primary">View Pages</h6>
                            ...
                            <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a href="{{route('admin.pages.edit',@$item->id)}}" class="btn btn-success">Edit</a>
                                            <a href="{{route('admin.pages.delete',@$item->id)}}" class="btn btn-danger deleteBtn">Delete</a>
                                        </td>
                                    </tr>
