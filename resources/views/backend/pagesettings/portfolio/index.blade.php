...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-3 text-gray-800">Portfolios</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 mt-2 font-weight-bold text-primary">View Portfolios</h6>
            <div class="float-right d-inline">
                <a href="{{ route('admin.portfolios.create') }}" class="btn btn-primary btn-sm"><i
                            ...
                            <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1">Portfolio Image</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1">Portfolio Image View</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1">Portfolio Category</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        <td>{{$item->id}}</td>
                                        <td><img class="mt-2" id="oldlogo" src="{{ asset($item->portfolio_image) }}"
                                            alt="logo" width="100" height="100" /></td>
                                        <td><img class="mt-2" id="oldlogo" src="{{ asset($item->portfolio_image_view) }}"
                                            alt="logo" width="100" height="100" /></td>
