...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-3 text-gray-800">Testimonial</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 mt-2 font-weight-bold text-primary">View Testimonial</h6>
            <div class="float-right d-inline">
                <a href="{{ route('admin.testimonialsection.create') }}" class="btn btn-primary btn-sm"><i
